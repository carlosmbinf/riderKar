...
import { TiendasCollection } from '../../collections/collections';
...
class App extends Component {
  ...
  componentDidMount = () => {
    ...
    Meteor.loginWithPassword('carlosmbinf@gmail.com', 'lastunas123', callback);
    // Meteor.call('addUser',
    // {
        ...
        <View style={estilos.contenedor}>
          <TouchableOpacity onPress={this.requestLocationPermission}>
            <Text style={estilos.texto}>
              Velocidad = {Number(this.state.speed).toFixed(2)}KM/h
            </Text>
            <Text>
          ...
          <Button
            icon="logout"
            mode="contained"
            onPress={() => Meteor.logout(function () {
...
let Ubicacion = withTracker((props) => {
